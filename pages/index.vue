          ...
          <div class="col-xl-3">
            <div class="app-guide">
              ...
              <p>
                ...
                site. Please, use your original email address.
              </p>
            </div>
          </div>
          <div class="col-xl-3">
          ...
          <div class="col-xl-3">
            <div class="app-guide">
              ...
              <p>
                ...
                Check your email and get the appointment time.
              </p>
            </div>
          </div>
        </div>
          ...
          <div class="col-xl-6">
            <div class="about-doctor-text">
              ...
              <p>
                ...
                Recusandae magnam velit, nulla neque deserunt nesciunt maxime
                unde. Facere dolores doloremque repudiandae odio sint
                necessitatibus quod eaque, tempora commodi soluta enim odit
                nulla delectus, laborum repellat quae ipsa eveniet voluptate
                recusandae consequuntur animi. Optio culpa quaerat eos fugiat
                officiis ipsam corrupti quisquam deleniti. Ratione corporis
                voluptas neque architecto animi similique fuga ipsa laudantium
                nam, blanditiis labore consequuntur, aspernatur nesciunt. Nemo
                minus maxime aperiam fugit!
              </p>
        ...
        <div class="row">
          <div class="col-xl-6 online-appointment-text">
            ...
            <p>
              ...
              ipsum. Blanditiis expedita cumque dolorem provident saepe
              mollitia, alias, eum voluptate non culpa qui consequuntur
              doloremque nostrum sunt minima iste aut porro error! Ad unde
              excepturi, quasi nam sed officia hic inventore natus ullam quos,
              atque labore dolores, porro minima maiores ab alias cupiditate.
              Quisquam rerum inventore repellendus accusantium esse ullam dolor,
              totam incidunt recusandae amet, exercitationem quasi libero.
              Adipisci sed blanditiis voluptate explicabo aperiam illo
              consectetur labore recusandae provident vitae itaque quo ratione
              error nihil, nam a quisquam repudiandae, impedit aut rerum!
              Cupiditate architecto nesciunt incidunt, dignissimos recusandae
              tenetur inventore?
            </p>
          </div>
          <div class="col-xl-6 online-appointment-image">
            <img
              src="~/assets/images/onlineappointment.jpg"
              alt="onlineappointment"
            />
          </div>
        </div>
      </div>
