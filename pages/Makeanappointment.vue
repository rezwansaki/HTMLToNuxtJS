<template>
  <div>
    <section class="appointment-area">
      <div class="container appointment-area-container">
        <div class="row">
          <div class="col-xl-12 appointment-area-main">
            <div class="appointment-area-main-title">Make an Appoinment</div>
            <div class="logged-in-user-info">
              You are logged in as <b>'Md. Rezwan Saki Alin'</b> and your user
              id is <b>5</b>.
            </div>

            <div class="logged-in-message">
              Note: Today is 29-December-2021 and you can apply for
              30-December-2021. A total of 80 patients will be seen. Quickly
              fill out the form and check the email. No more new applications
              will be accepted after 80 patients.
            </div>
            ...
            <form action="" method="">
              ...
              <div class="mb-3">
                ...
                <input
                  type="text"
                  class="form-control"
                  id="appoinmentbookingdate"
                  name="appoinmentbookingdate"
                  placeholder="dd/mm/yyyy"
                />
              </div>
              <div class="mb-3">
              ...
              <div class="mb-3">
                ...
                <select
                  class="form-select"
                  aria-label="Default select example"
                  id="patientfirstvisit"
                  name="patientfirstvisit"
                >
